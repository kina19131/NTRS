...
**⚠️ FURTHER CORRECTED 2026-08-02 — "last safe at ΔNLL=+0.032" above misapplies the stated criterion.** +0.032 (precisely 0.03218750) exceeds the 1% threshold (0.03058594) by 5.2% — it should have been classified as *broken*, not safe. Corrected: **Llama MNLI T* = [0.0404, 0.1331]** (last safe at lr=1e-5, first broken at lr=5e-5), which **overlaps** Mistral's [0.0715, 0.3243] at [0.0715, 0.1331] but is **not fully contained inside it** (Llama's lower bound sits below Mistral's). "Statistically indistinguishable... falls entirely inside" should be read going forward as "brackets overlap; containment was an overclaim." See `RAW_DATA.md`'s H1 MNLI table for the corrected arithmetic, applicable under both σ½ scope conventions.
